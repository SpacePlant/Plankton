...
class PRNG:
    PRNGInfo = namedtuple('PRNGInfo', ['name',          # The name of the PRNG
                                       ...
                                       'seed_entropy',  # The entropy of the seed (bits)
                                       'out_min',       # The smallest possible value generated by the PRNG
                                       'out_max',       # The largest possible value generated by the PRNG
    ...
    def _verify_input(self, vals):
        ...
        for val in vals:
            if not rng_info.out_min < val < rng_info.out_max:
                raise InvalidValueException(rng_info.out_min, rng_info.out_max)
...
class InvalidValueException(Exception):
    def __init__(self, out_min, out_max):
        super().__init__(self, 'Input values have to be from {} to {}.'.format(out_min, out_max))
